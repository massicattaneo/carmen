			...
			utils: {
				...
				printBills: function (list) {
					...
					list.forEach(function (b, i) {
						...
						doc.text('BASE IMPONIBLE', 140, 240, 'right'); doc.text(net.format('i.ff s'), 190, 240, 'right');
						doc.text('%', 140, 247, 'right'); doc.text('21%', 190, 247, 'right');
						doc.text('IVA', 140, 254, 'right'); doc.text(iva.format('i.ff s'), 190, 254, 'right');
						doc.setFontSize(16);
						doc.text('TOTAL', 140, 265, 'right'); doc.text(tot.format('i.ff s'), 190, 265, 'right');
